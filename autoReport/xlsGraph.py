...
wb = load_workbook(filename = 'D:\\pythonWs\\autoReport\\PER_PerfDayList_excel (2).xlsx')
#wb2 = load_workbook(filename = 'D:\\pythonWs\\autoReport\\patchSchedule.xlsx')
sheet_ranges = wb['sheet1']
#sheet_ranges2 = wb['sheet1']
ws = wb.active
#ws2 = wb2.active
...
wb.save("D:\\pythonWs\\autoReport\\PER_PerfDayList_excel (2).xlsx")